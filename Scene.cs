...
namespace RogueLikeGame
{
    class Scene
    {
        ...
        public Scene(Playing playing, TextBox textBox) 
        {
            ...
            this.constructor = new Constructor("Level1.csv");
            dimensions = constructor.getDimensions();


            string[] ioArray = File.ReadAllText("Content//Level1Event.csv").Split('\n');
